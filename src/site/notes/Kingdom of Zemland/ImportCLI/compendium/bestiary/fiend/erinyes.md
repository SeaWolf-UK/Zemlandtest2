...
> 
> Some erinyes carry a [rope of entanglement](compendium/items/rope-of-entanglement.md) (detailed in the Dungeon Master's Guide). When such an erinyes uses its Multiattack, the erinyes can use the rope in place of two of the attacks.{ #variant-rope-of-entanglement}
