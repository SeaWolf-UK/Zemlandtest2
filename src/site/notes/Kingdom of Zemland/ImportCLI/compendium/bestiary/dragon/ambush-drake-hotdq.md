...
```ad-statblock
title: Ambush Drake
![](compendium/bestiary/dragon/token/ambush-drake.png#token)
...
***Pack Tactics.*** The drake has advantage on an attack roll against a creature if at least one of the drake's allies is within 5 feet of the creature and the ally isn't [incapacitated](rules/conditions.md#incapacitated).
