...
***Deathly Choir.*** Any creature within 10 feet of Rahadin that isn't protected by a [mind blank](compendium/spells/mind-blank.md) spell hears in its mind the screams of the thousands of people Rahadin has killed. As a bonus action, Rahadin can force all creatures that can hear the screams to make a DC 16 Wisdom saving throw. Each creature takes 16 (`3d10`) psychic damage on a failed save, or half as much damage on a successful one.

***Fey Ancestry.*** Rahadin has advantage on saving throws against being [charmed](rules/conditions.md#charmed), and magic can't put him to sleep.
...
***Multiattack.*** Rahadin attacks three times with his scimitar, or twice with his [poisoned](rules/conditions.md#poisoned) darts.
