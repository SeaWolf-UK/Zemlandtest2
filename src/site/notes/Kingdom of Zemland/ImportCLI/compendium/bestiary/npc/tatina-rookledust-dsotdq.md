...
![](compendium/bestiary/npc/token/tatina-rookledust.png#token)
...
***Spellcasting.*** Tatina is a 1st-level spellcaster. Its spellcasting ability is Wisdom (spell save DC 12, +4 to hit with spell attacks). Tatina has following cleric spells prepared:
