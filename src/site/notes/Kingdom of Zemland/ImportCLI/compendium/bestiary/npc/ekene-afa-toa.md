...
```ad-statblock
title: Ekene-Afa
![](compendium/bestiary/npc/token/ekene-afa.png#token)
...
***Brave.*** Ekene-Afa has advantage on saving throws against being [frightened](rules/conditions.md#frightened).
