...
```ad-statblock
title: Rezmir
![](compendium/bestiary/npc/token/rezmir.png#token)
...
***Special Equipment.*** Rezmir has the [Black Dragon Mask](compendium/items/black-dragon-mask-hotdq.md), [Hazirawn](compendium/items/hazirawn-hotdq.md), and an [insignia of claws](compendium/items/insignia-of-claws-hotdq.md).
...
***Darkness (Costs 2 Actions).*** A 15-foot radius of magical darkness extends from a point Rezmir can see within 60 feet of her and spreads around corners. The darkness lasts as long as Rezmir maintains [concentration](rules/conditions.md#concentration), up to 1 minute. A creature with darkvision can't see through this darkness, and no natural light can illuminate it. If any of the area overlaps with a area of light created by a spell of 2nd level or lower, the spell creating the light is dispelled.
