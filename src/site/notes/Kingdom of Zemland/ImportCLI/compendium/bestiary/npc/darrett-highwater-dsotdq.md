...
```ad-statblock
title: Darrett Highwater
![](compendium/bestiary/npc/token/darrett-highwater.png#token)
...
***Brave.*** Darrett has advantage on saving throws against being [frightened](rules/conditions.md#frightened).
...
***Leadership (Recharges after a Short or Long Rest).*** For 1 minute, Darrett can utter a special command or warning whenever a nonhostile creature that it can see within 30 feet of it makes an attack roll or a saving throw. The creature can add a `d4` to its roll provided it can hear and understand Darrett. A creature can benefit from only one Leadership die at a time. This effect ends if Darrett is [incapacitated](rules/conditions.md#incapacitated).
