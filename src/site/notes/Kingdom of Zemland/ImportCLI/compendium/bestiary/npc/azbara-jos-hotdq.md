...
```ad-statblock
title: Azbara Jos
![](compendium/bestiary/npc/token/azbara-jos.png#token)
...
***Special Equipment.*** Azbara has two [scrolls](compendium/items/spell-scroll-1st-level.md) of [mage armor](compendium/spells/mage-armor.md).
...
**1st level (4 slots)**: [fog cloud](compendium/spells/fog-cloud.md), [magic missile](compendium/spells/magic-missile.md), [shield](compendium/spells/shield.md), [thunderwave](compendium/spells/thunderwave.md)

**2nd level (3 slots)**: [invisibility](compendium/spells/invisibility.md), [misty step](compendium/spells/misty-step.md), [scorching ray](compendium/spells/scorching-ray.md)
