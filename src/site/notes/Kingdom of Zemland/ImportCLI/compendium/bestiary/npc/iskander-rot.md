...
```ad-statblock
title: Iskander
![](compendium/bestiary/npc/token/iskander.png#token)
...
***5etools Note.*** Iskander is presented in The Rise of Tiamat as a neutral evil male human wizard. The [mage](compendium/bestiary/humanoid/mage.md) stat block has been provided here for ease of use.
