...
```ad-statblock
title: Sekelok
![](compendium/bestiary/npc/token/sekelok.png#token)
...
**At will**: [animal friendship](compendium/spells/animal-friendship.md) (snakes only), [poison spray](compendium/spells/poison-spray.md)

**3/day each**: [suggestion](compendium/spells/suggestion.md)
