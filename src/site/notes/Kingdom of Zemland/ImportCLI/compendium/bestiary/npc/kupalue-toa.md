...
```ad-statblock
title: Kupalué
![](compendium/bestiary/npc/token/kupalue.png#token)
*Small plant, Neutral*
...
***Plant Camouflage.*** Kupalué has advantage on Dexterity ([Stealth](rules/skills.md#Stealth)) checks it makes in any terrain with ample obscuring plant life.
