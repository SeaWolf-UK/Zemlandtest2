...
![](compendium/bestiary/npc/token/maccath-the-crimson.png#token)
...
***5etools Note.*** Maccath the Crimson is presented in The Rise of Tiamat as a female tiefling sorcerer and member of the Arcane Brotherhood. The [mage](compendium/bestiary/humanoid/mage.md) stat block, modified with tiefling racial traits, has been provided here for ease of use.
