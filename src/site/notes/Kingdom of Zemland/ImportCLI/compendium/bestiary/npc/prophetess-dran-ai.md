...
```ad-statblock
title: Prophetess Dran
![](compendium/bestiary/npc/token/prophetess-dran.png#token)
...
***Fey Ancestry.*** Prophetess has advantage on saving throws against being [charmed](rules/conditions.md#charmed), and magic can't put her to sleep.
