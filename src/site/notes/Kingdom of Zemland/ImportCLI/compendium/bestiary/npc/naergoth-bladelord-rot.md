...
![](compendium/bestiary/npc/token/naergoth-bladelord.png#token)
...
***Sunlight Sensitivity.*** While in sunlight, Naergoth has disadvantage on attack rolls, as well as on Wisdom ([Perception](rules/skills.md#Perception)) checks that rely on sight.
