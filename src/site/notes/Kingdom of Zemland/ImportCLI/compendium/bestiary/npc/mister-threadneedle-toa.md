...
```ad-statblock
title: Mister Threadneedle
![](compendium/bestiary/npc/token/mister-threadneedle.png#token)
...
***Claw.*** *Melee Weapon Attack:* +3 to hit, reach 5 ft., one target. *Hit:* 6 (`2d4 + 1`) slashing damage. If the target is a creature, it must succeed on a DC 11 Wisdom saving throw or be [frightened](rules/conditions.md#frightened) until the end of Mister Threadneedle's next turn.

***Terrifying Glare.*** Mister Threadneedle targets one creature it can see within 30 feet of it. If the target can see Mister Threadneedle, the target must succeed on a DC 11 Wisdom saving throw or be magically [frightened](rules/conditions.md#frightened) until the end of Mister Threadneedle's next turn. The [frightened](rules/conditions.md#frightened) target is [paralyzed](rules/conditions.md#paralyzed).
```
^statblock